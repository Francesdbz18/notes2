...
5. troubleshoot, repair, download, assemble, an upgrade
6. solve problems, operate a machine, design a webpage, give support, input data, check the connections
7. design a webpage, give support, solve problems, check the connections, input data, operate a machine
8. 
	1. programmer
...
2. dialogue
	...
	2. what do you need to use it for?
	3. do you want to use it for downloading music and films?
	4. it's a special offer this week
4. 
	1. B
	2. B
	3. A
